!!! note
    This page mirrors [`experiments/readme.md`](https://github.com/Red1-Rahman/NiriZan/blob/main/experiments/readme.md) in the repo. Notebook links open on GitHub — clone the repo or use Colab/Kaggle to run them.
