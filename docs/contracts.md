...
* Duplicate `(trace_id, metric_name)` records make the entire trace ambiguous and are dropped. This rejection is independent of input order; selecting first-wins or last-wins would make the resulting matrix depend on list order.
