...
class NiriZanToOTelExporter(BaseExporter):
    ...
    Note on Trace Identifiers:
        Root spans generated by this exporter receive OpenTelemetry trace IDs generated by
        the configured `TracerProvider`. The original NiriZan trace ID is preserved in
        the `NIRIZAN_TRACE_ID` (`nirizan.trace_id`) span attribute for cross-system lookup.
        Child spans automatically inherit the OpenTelemetry trace ID of their parent span.
    """
